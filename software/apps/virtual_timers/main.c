...
int main(void) {
  ...
  uint32_t timer_id1 = virtual_timer_start_repeated(1000000, led1_toggle);
  uint32_t timer_id2 = virtual_timer_start_repeated(2000000, led2_toggle);
  uint32_t timer_id3 = virtual_timer_start_repeated(4000000, led3_toggle);
  nrf_delay_ms(16000);
  virtual_timer_cancel(timer_id2);
  virtual_timer_cancel(timer_id3);
